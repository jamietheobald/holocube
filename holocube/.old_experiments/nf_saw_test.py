...
for i in [0, 1]:
    s.add_test(apts.on, 1, 0,
               ...
               # window.ref_color_1,  tri_dir*127+127,                     1,
               # ard.pip,             tri_dir+4,                           1,
...
# next move only one set of points as a triangle while the speed of the other varies
spds = [.5, 1, 1.5, 2, 3, 4]
for i in spds:
    s.add_test(apts.on, 1, 0,
               bpts.on, 1, 0,
...
# then vary the speed of the triangle pts while the other stays fixed
spds = [.5, 1, 1.5, 2, 3, 4]
for i in spds:
    s.add_test(apts.on, 1, 0,
               bpts.on, 1, 0,
