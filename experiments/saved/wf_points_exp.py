...
# this is a list of the motion type, and the amplification
# needed to make it reasonable on screen
motions = [[pts.set_rx, rot_amp], [pts.set_ry, rot_amp], [pts.set_rz, rot_amp], [pts.set_px, pos_amp],
           [pts.set_py, pos_amp], [pts.set_pz, pos_amp]]
